...
if(isset($_POST['submit'])){
    $to = "bam326@gmail.com"; // this is your Email address
...
<div class="container-fluid bg-3 text-center">
  ...
  <div class="row text-center">
    ...
    <form id="form1" action="mailto:bam326@gmail.com" method="get">
            <div style="margin-bottom:10px">
                <label for="text">Name</label><br>
                <input required type="text" id="text" name="text" value="">
            </div>

            <div style="margin-bottom:10px">
                <input type="radio" id="radio1" name="radio" value="radio 1 value" checked>
                <label for="radio1">Dog Walking</label><br>
                <input type="radio" id="radio2" name="radio" value="radio 2 value">
                <label for="radio2">Daycare</label>
            </div>

            <div style="margin-bottom:10px">
                <label for="textarea">Message</label><br>
                <textarea cols="60" rows="5" name="textarea" id="textarea"></textarea>
            </div>
